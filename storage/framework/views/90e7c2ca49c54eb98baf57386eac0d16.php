                    ...
                    <select name="product_color[]" id="product_color" class="form-control" multiple>
                        <?php $__currentLoopData = ['red', 'blue', 'green', 'yellow', 'black', 'white', 'orange', 'purple']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($color); ?>"
                                <?php echo e((is_array(old('product_colors', $product->product_colors ?? [])) && in_array($color, old('product_colors', $product->product_colors ?? []))) ? 'selected' : ''); ?>>
                    ...
                    <select name="product_size[]" id="product_size" class="form-control" multiple>
                        <?php $__currentLoopData = ['S', 'M', 'L', 'XL', 'XXL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($size); ?>"
                                <?php echo e((is_array(old('product_sizes', $product->product_sizes ?? [])) && in_array($size, old('product_sizes', $product->product_sizes ?? []))) ? 'selected' : ''); ?>>
                                <?php echo e($size); ?>
